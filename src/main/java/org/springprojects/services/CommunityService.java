...
public class CommunityService
{
    ...
    {
        List<CreateOrRetrieveCommunityDTO> communities = CommunityMapper.INSTANCE.toDTOList(communityRepository.findAll());

        List<EntityModel<CreateOrRetrieveCommunityDTO>> emlist = communities.stream().map(community ->
...
//        CollectionModel.of(communities);
        ...
        CollectionModel<EntityModel<CreateOrRetrieveCommunityDTO>> model = CollectionModel.of(emlist);
    ...
    public ResponseEntity<EntityModel<CreateOrRetrieveCommunityDTO>> createCommunity(CreateOrRetrieveCommunityDTO communityDTO)
    {
